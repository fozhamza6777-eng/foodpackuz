...
- Buyurtma berilganiga **1 soatdan kam** vaqt o'tgan bo'lsa, mijoz uni bir bosishda, sababsiz bekor
  qila oladi.
- **1 soatdan ko'p** vaqt o'tgan bo'lsa, mijozdan bekor qilish sababi so'raladi (majburiy) — buyurtma
  "Bekor so'ralgan" holatiga o'tadi va admin panelda ko'rib chiqilishini kutadi.
- Bularning barchasi ma'lumotlar bazasi darajasida (RLS) himoyalangan — mijoz faqat o'z
  buyurtmasini, faqat shu qoidalarga mos holatga o'zgartira oladi, boshqa hech qanday maydonni
  (narx, mahsulotlar va h.k.) o'zgartira olmaydi.
...
Mahsulotlar asosan ulgurji sotilgani uchun katalogda **ham dona narxi, ham pachka narxi** ko'rsatiladi
(pachka narxi = dona narxi × qadoq hajmi). Savatga qo'shish paytidagi +/- tugmalari **pachka**
birligida hisoblaydi — masalan, agar stakan 100 donalik qadoqda sotilsa, mijoz "1" ni tanlaganda
avtomatik 100 dona (1 pachka) savatga qo'shiladi. Katalogda mahsulot allaqachon savatda bo'lsa,
uning ustida yashil **"Savatda: N pachka"** belgisi chiqadi — bu mijozni bir xil mahsulotni bilmasdan
qayta-qayta qo'shib yubormasligiga yordam beradi.
