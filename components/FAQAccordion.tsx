...
const faqs = [
  ...
  },
  {
    ...
    a: "Saytda barcha hamkorlar uchun umumiy minimal narxlar ko'rsatilgan. 5 000 000 so'mdan yuqori bir martalik buyurtmalarda individual narx muhokama qilinishi mumkin."
  },
  {
