...
import { ChevronLeft, ChevronRight, ArrowRight, Truck, ShieldCheck, Percent } from "lucide-react";
...
const slides = [
  ...
  {
    tag: "-30%gacha chegirma",
    tagIcon: Percent,
    title: "Pitsa qutilari va termo-konteynerlarga mavsumiy chegirma",
    text: "100 donadan buyurtma berganda qo'shimcha chegirma avtomatik qo'llanadi.",
